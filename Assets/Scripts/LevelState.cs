/// Ersan - 150918 - This class contains the data for every level such as: solution(which is the sequence of object
/// s shown on the screen) , user`s input, the object duration, 
...
public class LevelState
{
    ...
    public float objectDuration = 1f;
